        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/shop" className="text-gray-400 hover:text-emerald-400 transition-colors">Shop</Link></li>
              <li><Link to="/learn" className="text-gray-400 hover:text-emerald-400 transition-colors">Learn</Link></li>
              <li><Link to="/community" className="text-gray-400 hover:text-emerald-400 transition-colors">Community</Link></li>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input type="email" placeholder="Enter your email" className="bg-gray-800 border-gray-700 text-white px-3 py-2 rounded-md flex-grow" />
